...
export default async function (eleventyConfig) {
  // Handle draft posts: Mark title and exclude from production builds
  ...
  eleventyConfig.addPassthroughCopy({
    "./public/": "/",
    "src/feed/simple-rss.xslt": "feed/simple-rss.xslt",
    "src/feed/simple-atom.xslt": "feed/simple-atom.xslt",
